...
import MSR from '../Inventory/Img/SwarnaLogo.png';
...
const InventoryRecord = () => {
    ...
    return (
      ...
      <h2 style={{textAlign:'center' , marginBottom:'35px' , marginTop:'35px', fontSize:'30px' , textDecoration:'underline', fontWeight:'700',color:'#81684A'}}>All Records</h2>
