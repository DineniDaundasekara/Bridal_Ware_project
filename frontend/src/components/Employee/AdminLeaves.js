...
export default function AdminLeaves() {
    const [leaves, setLeaves] = useState([]);
    const [selectedDescription, setSelectedDescription] = useState("");
    const [selectedCategory, setSelectedCategory] = useState("Pending"); // State for selected category
            ...
            <div className="container">
                <div className="row my-3">
                    <div className="col text-center">
                        <button
                            className={`btn btn-${selectedCategory === "Pending" ? "primary" : "secondary"} mx-2 my-1`}
                            style={{ fontSize: '18px', padding: '10px 20px', backgroundColor:'#5B3E31',border:'#5B3E31',color:'#EDE1D2' }}
                            onClick={() => setSelectedCategory("Pending")}
                        >
                            Pending Leaves
                        </button>
                        <button
                            className={`btn btn-${selectedCategory === "Approved" ? "primary" : "secondary"} mx-2 my-1`}
                            style={{ fontSize: '18px', padding: '10px 20px', backgroundColor:'#5B3E31',border:'#5B3E31',color:'#EDE1D2'  }}
                        ...
                        <button
                            className={`btn btn-${selectedCategory === "Rejected" ? "primary" : "secondary"} mx-2 my-1`}
                            style={{ fontSize: '18px', padding: '10px 20px', backgroundColor:'#5B3E31',border:'#5B3E31',color:'#EDE1D2'  }}
                ...
                <div className="table-responsive">
                    <table className="table">
                        <thead className="thead-light">
                            <tr>
                                <th scope="col" style={{ backgroundColor: '#63483D',color:'white' }}>#</th>
                                <th scope="col" style={{ backgroundColor: '#63483D',color:'white' }}>Employee ID</th>
                                <th scope="col" style={{ backgroundColor: '#63483D',color:'white' }}>Leave Reason</th>
                                <th scope="col" style={{ backgroundColor: '#63483D',color:'white' }}>Date From</th>
                                <th scope="col" style={{ backgroundColor: '#63483D',color:'white' }}>Date To</th>
                                <th scope="col" style={{ backgroundColor: '#63483D',color:'white' }}>Description</th>
                                <th scope="col" style={{ backgroundColor: '#63483D',color:'white' }}>Leave Status</th>
                                <th scope="col" style={{ backgroundColor: '#63483D',color:'white' }}>Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            {leaves
                                .filter(leave => leave.leaveStatus === selectedCategory)
                                .map((leave, index) => (
                                    <tr key={leave._id}>
                                        <td>{index + 1}</td>
                                        <td>{leave.Eid}</td>
