...
const InquiryDashboard = () => {
    ...
    return (
        <div className='bg' style={{backgroundColor: '#D0BCA0'}}>
            ...
            <div className={style0.heading1} style={{backgroundColor: '#D0BCA0'}}>
            ...
            <div className={style0.inquiry_summary_container} style={{backgroundColor: '#D0BCA0'}}>
                <h2 style={{color: '#81684A',fontWeight:'bold'}}>Today's Summary</h2>
                <div className={style0.summary_item}>
                    <div className={style0.item}>
                        <h3 style={{color: '#4D3925',fontWeight:'bold'}}>Total Received </h3>
                        <div className={style0.item_value} style={{background:'#997756'}}>
                            <p style={{ margin: '0' ,fontWeight:'650',fontSize:'22px'}}>{totalInquiries}</p>
                        </div>
                    </div>
                    <div className={style0.item} style={{marginLeft:'35px'}}>
                        <h3 style={{color: '#4D3925',fontWeight:'bold'}}>Replied Inquiries</h3>
                        <div className={style0.item_value}  style={{background:'#997756'}}>
                            <p style={{ margin: '0' ,fontWeight:'650',fontSize:'22px'}}>{repliedCount}</p>
                        </div>
                    </div>
                    <div className={style0.item}>
                        <h3 style={{color: '#4D3925',fontWeight:'bold'}}>Pending Inquiries</h3>
                        <div className={style0.item_value}  style={{background:'#997756'}}>
