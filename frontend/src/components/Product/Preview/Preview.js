...
import MSRLogo from '../../../res/Swarna.png';
...
const Preview = () => {
  ...
  return (
    <div className='bg' style={{backgroundColor: '#D0BCA0'}}>
      <div>
      <div style={{ position: 'relative' ,backgroundColor: '#5B3E31' }}>
           <SideBar/>
            
            
            {/* Header */}
            <div className="header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px 20px', backgroundColor: '#5B3E31', flexGrow: 1 }}>
                <div className="logo">
                ...
                <div className="header-content" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    {/* Your header content */}
                    {/* Input container */}
                    <div className="InputContainer" style={{ background:'#D0BCA0', height: '40px', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: '10px', overflow: 'hidden', cursor: 'pointer', paddingLeft: '15px', boxShadow: '2px 2px 10px rgba(0, 0, 0, 0.075)' }}>
                        <input type="text" name="text" className="input" id="input" value={searchQuery}
  onChange={handleChange}  placeholder="Search" style={{ width: '200px', height: '100%', border: 'none', outline: 'none', fontSize: '0.9em', caretColor: 'rgb(255, 81, 0)', background:'#D0BCA0'}} />
                        <label htmlFor="input" className="labelforsearch" style={{ cursor: 'text', padding: '0px 12px',background:'#D0BCA0' }}>
                            <svg viewBox="0 0 512 512" className="searchIcon" style={{ width: '13px',background:'#D0BCA0' }}>
                                <path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"></path>
                            </svg>
                        </label>
                        {/* <div className="border" style={{ height: '40%', width: '1.3px', backgroundColor: '#5B3E31' }}></div>
                        <button className="micButton" style={{ border: 'none', backgroundColor: 'transparent', height: '40px', cursor: 'pointer', transitionDuration: '.3s', width: '40px' }}>
                            <svg viewBox="0 0 384 512" className="micIcon" style={{ width: '120px' }}>
      ...
      <h1 style={{ color: 'white'}}>Preview Products</h1>

</div>
<div className="sort-buttons" style={{ display: 'flex', justifyContent: 'center', marginBottom: '20px' }}>
  <button className="sort-button" onClick={() => handleSort('all')} style={{ color: 'white', borderRadius: '5px', border: 'none', padding: '10px 20px', cursor: 'pointer', marginRight: '10px', backgroundColor: 'transparent',background:'#5B3E31' }}>All</button>
  <span style={{ color: 'gray', padding: '0 5px', marginTop: '22px', marginRight: '3px' }}>|</span>
  <div className="dropdown-menu" style={{ position: 'relative', display: 'inline-block' , border:'none',background:'#5B3E31'}}>
    <button className="sort-button" onClick={() => handleSort('rent')} style={{ color: 'white', borderRadius: '5px', border: 'none', padding: '10px 20px', cursor: 'pointer', backgroundColor: 'transparent',background:'#5B3E31' }}>Rent</button>
    <span style={{ color: 'gray', padding: '0 5px', marginTop: '10px' }}>|</span>
    <select className="filter-select" onChange={(e) => handleSort('buy', e.target.value)} style={{color: 'white', borderRadius: '5px', border: 'none', padding: '10px 20px', top: '100%', left: '0', cursor: 'pointer', backgroundColor: 'transparent' }}>
      <option style={{ color: 'gray', padding: '0 5px' }} value="">Buy</option>
      <option style={{ color: 'gray', padding: '0 5px' }} value="suit">Bridal Saree</option>
      <option style={{ color: 'gray', padding: '0 5px' }} value="shirt">Bridemaid Saree</option>
      <option style={{ color: 'gray', padding: '0 5px' }} value="trousers">Wedding Frock</option>
      <option style={{ color: 'gray', padding: '0 5px' }} value="tie">Jewellery</option>
      <option style={{ color: 'gray', padding: '0 5px' }} value="bow">Flower bouquet</option>
