...
import Logo from "../Inquiry/Img/Swarna.png"
import Background from "../Inquiry/Img/forgot2.jpeg"; // Add your background
...
//<div className="container" style={{display:'grid',marginBottom:'35px', width:'35%', border:'1px solid #ccc', padding:'30px', marginTop:'90px', backgroundColor: 'black'}}>
  return (
    // <div  style={{ backgroundColor: '#f4ba6e', height: '100vh', display: 'flex', alignItems: 'bottom', justifyContent: 'center'}}>
    <div  
    style={{
  ...
  >
      ...
      <div class="container" style={{display:'grid',marginBottom:'40px', width:'35%', border:'1px solid #ccc', padding:'30px', marginTop:'30px', backgroundColor:'rgba(178, 190, 181, 0.5)',borderRadius:'20px'}}> 
      <div>
      <img src={Logo} style={{ width: '80px', margin: '0 auto', display: 'block', marginTop:'40px',marginBottom:'20px',borderRadius:'100px' }}></img>
      </div>    
          <hr></hr>
      <h2 style={{textAlign:'center', marginBottom:'80px',textDecoration:'underline', marginTop:'10px', color:'black'}}>Reset Password</h2>
      { !otpSent && (
        <div>
          <div class="form-group" style={{display:'grid',width:'100%'}} >
            <input style={{width:'100%', padding:'12px', marginBottom:'80px'}} type="email" class="form-control" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Enter your email" />
          </div>
          <div style={{justifyContent:'center', display:'flex'}}>        
            <button style={{width:'30%',padding:'12px', fontWeight:'600', backgroundColor:'#3f0f06', borderRadius:'0px', border:'none', marginTop:'10px'}} class="btn btn-primary" onClick={handleCheckEmail}>Check Email</button>
          </div>
        </div>
      )}
      {emailExists && !otpSent && (
