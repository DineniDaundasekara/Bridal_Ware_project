...
const RentCheckout = () => {
  ...
  return (
    <div className="container vh-100 d-flex align-items-center justify-content-center p-3 ">
      <div className="card p-4" style={{ maxWidth: '500px', width: '100%',background:'#EDE6D9',position:'relative' }}>
      <h2 style={{color:'#D0BCA0',textAlign:'center'}}>Checkout</h2><br />
      <div style={{textAlign:'center'}}>Total Amount: ${totalAmount.toFixed(2)}</div>
