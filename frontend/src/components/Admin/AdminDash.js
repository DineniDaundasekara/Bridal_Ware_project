...
//remove this
  ...
  return (
    <div className='bg' style={{backgroundColor: '#D0BCA0',marginLeft:'-19.99px',marginRight:'-20px',paddingBottom:'500px'}}>
      <div className={styles["header-content"]}>
        <div style={{ textAlign: "center", display: "flex" }}>
          <p style={{ color: "#D0BCA0" }}>SWARNA</p>
          <p style={{ color: "#2C221B", marginLeft: "20px" }}>BRIDALWARE</p>
        </div>
      </div>
