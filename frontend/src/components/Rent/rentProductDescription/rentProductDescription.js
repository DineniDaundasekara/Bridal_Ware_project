...
const RentProductDescription = () => {
  ...
  const handleAddToCart = async () => {
    try {
      ...
      console.error("This product is already rented for the selected dates.", error);
      // alert('This product is already rented for the selected dates.');
      Swal.fire({
        icon: 'error',
        title: 'Sorry!',
        text: 'This product is already rented for the selected dates',
        confirmButtonText: 'OK'
      });
        ...
        <div className="row">
          ...
          <div className="col-md-4">
            <div className="product-details">
              ...
              <div>
                <button className="btn btn-dark btn-block" onClick={handleAddToCart} style={{ backgroundColor: 'rgb(161, 141, 113)', borderRadius: '7px', fontWeight:'bold' }}>Add to Cart</button>
              </div>
            </div>
          </div>
        </div>
