...
`;
    ...
    return (
        <div className='bg' style={{backgroundColor: '#D0BCA0'}}>
            ...
            <div className={style.heading} style={{ marginBottom: '30px', textAlign: 'center', backgroundColor: '#D0BCA0' }}>
      ...
      {/* <button
            ...
            <div style={{ margin: '0 auto', width: '50%', padding: '150px', boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.1)', borderRadius: '10px', textAlign: 'center' }}>
                <div style={{ marginBottom: '20px', color: 'black', textAlign: 'justify' }}>
                    <p>Swarna Bridal Ware generates comprehensive weekly and monthly reports, offering critical insights into product performance over defined periods. These reports equip stakeholders with valuable data on product details, emerging trends, and average pricing, enabling them to make informed decisions. With these detailed analyses, product managers and decision-makers can fine-tune strategies to drive business growth and optimize outcomes.</p>
                </div>
                ...
                <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: '10px' }}>
                    <button onClick={generateReport} disabled={isLoading} style={{ padding: '10px', backgroundColor: '#5B3E31', color: '#EDE1D2', border: 'none', borderRadius: '1px' }}>
