...
export default function Report() {
  ...
  return (
    <div className='bg' style={{backgroundColor: '#D0BCA0'}}>
      <Header/>
      <div style={{ marginTop:'80px' ,marginLeft:'70px', marginRight:'40px', height: '100%'}} >
        <h1 style={{textAlign:'center' , marginTop:'30px', marginBottom:'30px',color:'#81684A'}}>Summary Report</h1>
        <p style={{textAlign:'center', marginTop:'20px' , marginLeft:'50px', marginRight:'50px' , fontSize:'20px',marginBottom:'30px', height: '90%'}} >
