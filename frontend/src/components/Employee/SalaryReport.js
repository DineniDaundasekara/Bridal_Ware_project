  ...
  return (
    <div className='bg' style={{backgroundColor: '#D0BCA0'}}>
      ...
      <div style={{ marginLeft: 150 }}>
        <h2 style={{textAlign: "center",color:"#81684A"}}>Salary Report</h2>
        <hr />
        ...
        <br />
        <hr />
        <h6 style={{ color:"#5B3E31"}}>Please choose the month:</h6>
        <select className="form-select mb-3" value={selectedMonth} onChange={handleMonthChange} style={{ background:"#5B3E31",color:'#EDE1D2'}}>
